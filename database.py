...
def seed_default_substances() -> None:
    ...
    defaults = [
        ...
        (1,  "O2 (Kislorod)",        6.0,    "mg/dm3", 4, True),
        (2,  "KBI5",                 3.0,    "mg/dm3", 4, False),
        (3,  "KKI",                  15.0,   "mg/dm3", 4, False),
        (4,  "Fenol",                0.001,  "mg/dm3", 2, False),
        (5,  "Neft mahsulotlari",    0.05,   "mg/dm3", 4, False),
        (6,  "N-NO2-",               0.02,   "mg/dm3", 3, False),
        (7,  "N-NO3-",               9.0,    "mg/dm3", 3, False),
        (8,  "N-NH4+",               0.39,    "mg/dm3", 3, False),
        (9,  "Temir umumiy (Fe)",    0.5,    "mg/dm3", 3, False),
        (10, "Mis (Cu)",             1.0,  "mg/dm3", 2, False),
        (11, "Rux (Zn)",             10.0,   "mg/dm3", 3, False),
        (12, "Xrom (Cr)",            1.0,  "mg/dm3", 2, False),
        (13, "Kadmiy (Cd)",          0.001,  "mg/dm3", 2, False),
        (14, "Qo'rg'oshin (Pb)",     0.03,  "mg/dm3", 2, False),
